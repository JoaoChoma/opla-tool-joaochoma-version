						...
						.addGroup(panelMetricsLayout.createSequentialGroup().addGap(14, 14, 14).addGroup(
								panelMetricsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										...
										.addGroup(panelMetricsLayout.createSequentialGroup()
												...
												.addGroup(panelMetricsLayout
														.createParallelGroup(GroupLayout.Alignment.BASELINE)
														.addComponent(checkAcomp).addComponent(checkEc))
												.addGroup(panelMetricsLayout
														.createParallelGroup(GroupLayout.Alignment.BASELINE)
														.addComponent(checkAclass).addComponent(checkDc))
												.addGroup(panelMetricsLayout
														.createParallelGroup(GroupLayout.Alignment.BASELINE)
														.addComponent(checkTam).addComponent(checkCoe))
												.addGroup(panelMetricsLayout
														.createParallelGroup(GroupLayout.Alignment.BASELINE)
														.addComponent(checkPLAExt).addComponent(checkElegance))
